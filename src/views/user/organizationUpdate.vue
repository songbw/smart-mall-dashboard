<template class="org-update-container">
  <div>
    <el-dialog
      :before-close="org_update_handleClose"
      ...
      <el-form ref="form" :model="form" :rules="formRules" class="org-update-form" label-position="right" type="flex">
        ...
        <br>
        <div align="left" >
          <el-button :span="20" type="primary" style="width:100%; font-size:18px;" @click.native.prevent="org_update_handleSubmit">
            {{ $t('confirm_button_ok_title') }}
          </el-button>
        </div>
        <br>
        <div align="left" >
          <el-button type="cancel" style="width:100%; font-size:18px;" @click="org_update_handleClose">
