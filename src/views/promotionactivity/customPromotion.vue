    ...
    computed: {
      ...
      promotionName: {
        ...
        set(value) {
          ...
          this.$store.commit('setPromotionName', value)
        }
      },
      promotionTagValue: {
        get() {
        ...
        set(value) {
          if (this.promotionData) {
            ...
            for (const tag of this.promotionOptions) {
              if (tag.value === value) {
                this.$store.commit('setPromotionTag', tag.label)
                break
              }
            }
          }
      ...
      promotionStartDate: {
        ...
        set(value) {
          ...
          this.$store.commit('setPromotionStartDate', value)
        }
      },
      promotionEndDate: {
        get() {
        ...
        set(value) {
          ...
          this.$store.commit('setPromotionEndDate', value)
        }
      }
    },
    methods: {
      ...
      handleCreatePromotion() {
        ...
        this.$store.dispatch('createPromotion', params).then(() => {
