<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('vendors')">
        <div class="card-panel-icon-wrapper icon-vendor">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="0" :duration="1000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
