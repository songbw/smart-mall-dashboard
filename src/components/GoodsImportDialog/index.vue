...
const CreationHeaders = [
  ...
  { field: 'name', label: '商品名称', type: 'string', template: '*测试商品(必填项)' },
  { field: 'subTitle', label: '商品副标题', type: 'string', template: '*测试商品副标题(可填项)' },
  { field: 'category', label: '商品类别', type: 'string', template: '厨卫清洁/纸制品/手帕纸(可填项)' },
  { field: 'brand', label: '商品品牌', type: 'string', template: '*品牌(可填项)' },
...
const UpdateHeaders = [
  ...
  { field: 'name', label: '商品名称', type: 'string', template: '*测试商品(可填项)', changeOnSale: false },
  { field: 'subTitle', label: '商品副标题', type: 'string', template: '*测试商品副标题(可填项)', changeOnSale: true },
  { field: 'category', label: '商品类别', type: 'string', template: '厨卫清洁/纸制品/手帕纸(可填项)', changeOnSale: true },
  { field: 'brand', label: '商品品牌', type: 'string', template: '*品牌(可填项)', changeOnSale: true },
